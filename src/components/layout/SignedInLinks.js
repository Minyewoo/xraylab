...
const SignedInLinks = (props) => {
    return (
        <ul className="header__nav nav--header">
            ...
            {/* <img className="icon--ml" src={process.env.PUBLIC_URL + "/img/ico_add.svg"} alt=''/> */}
            <li className="nav--header__item nav__item"><NavLink className="nav--header__link" to='/dashboard/all'>Dashboard</NavLink></li>
